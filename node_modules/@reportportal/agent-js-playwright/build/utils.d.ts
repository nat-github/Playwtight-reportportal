...
export declare const getAttachments: (attachments: TestResult['attachments'], { uploadTrace, uploadVideo }?: AttachmentsConfig, testTitle?: string) => Promise<Attachment[]>;
...
export declare const safeParse: (input: unknown) => any;
export {};
